...
const SHELL = ['./', './index.html', './data/exhibit-data.js?v=1.52.0', './fonts/fonts.css', './vendor/leaflet/leaflet.js', './vendor/leaflet/leaflet.css', './methodology.html', './about.html', './terms.html', './contact.html', './manifest.json', './sitemap.xml', './404.html'];
